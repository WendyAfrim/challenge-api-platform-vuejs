 ...
 */
final class Version20230118140123 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE SEQUENCE user_property_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        ...
        $this->addSql('CREATE TABLE property (id INT NOT NULL, title VARCHAR(255) NOT NULL, address VARCHAR(255) NOT NULL, zipcode VARCHAR(5) NOT NULL, country VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, type VARCHAR(255) NOT NULL, rooms INT DEFAULT NULL, surface SMALLINT DEFAULT NULL, has_balcony BOOLEAN DEFAULT NULL, has_terrace BOOLEAN DEFAULT NULL, has_cave BOOLEAN DEFAULT NULL, has_elevator BOOLEAN DEFAULT NULL, has_parking BOOLEAN DEFAULT NULL, price INT NOT NULL, heat_type VARCHAR(255) DEFAULT NULL, is_furnished BOOLEAN DEFAULT NULL, state VARCHAR(255) DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE user_property (id INT NOT NULL, lodger_id INT DEFAULT NULL, property_id INT DEFAULT NULL, is_validated BOOLEAN DEFAULT NULL, is_accepted BOOLEAN DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_6B7FF8DE36790F15 ON user_property (lodger_id)');
        $this->addSql('CREATE INDEX IDX_6B7FF8DE549213EC ON user_property (property_id)');
        $this->addSql('COMMENT ON COLUMN user_property.created_at IS \'(DC2Type:datetime_immutable)\'');
        $this->addSql('COMMENT ON COLUMN user_property.updated_at IS \'(DC2Type:datetime_immutable)\'');
        ...
        $this->addSql('ALTER TABLE user_property ADD CONSTRAINT FK_6B7FF8DE36790F15 FOREIGN KEY (lodger_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE user_property ADD CONSTRAINT FK_6B7FF8DE549213EC FOREIGN KEY (property_id) REFERENCES property (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP SEQUENCE user_property_id_seq CASCADE');
        ...
        $this->addSql('ALTER TABLE user_property DROP CONSTRAINT FK_6B7FF8DE36790F15');
        $this->addSql('ALTER TABLE user_property DROP CONSTRAINT FK_6B7FF8DE549213EC');
